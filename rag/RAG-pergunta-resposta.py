...
try:
    ...
    loader = DirectoryLoader('./RAG_MGI/data/', glob="**/*.md", loader_cls=lambda file_path: TextLoader(file_path, encoding='utf-8'), show_progress=True)
    ...
    # Interface simples para fazer perguntas
    while True:
